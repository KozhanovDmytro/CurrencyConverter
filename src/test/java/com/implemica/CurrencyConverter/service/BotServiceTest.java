...
public class BotServiceTest {
    ...
    */
   private static final String WRONG_CONTENT = BotService.WRONG_CONTENT;
   /**
   ...
   void roundingTest() {
      ...
      checkRounding("jpy", "0.00000001", "0");
      checkRounding("jpy", "0.0000001", "0");
      checkRounding("jpy", "0.000001", "0");
      checkRounding("jpy", "0.00001", "0");
      checkRounding("jpy", "0.0001", "0");
      checkRounding("jpy", "0.001", "0");
      checkRounding("jpy", "0.004", "0");
      checkRounding("jpy", "0.0049", "0");
      checkRounding("jpy", "0.005", "0.01");
      checkRounding("jpy", "0.009", "0.01");
      checkRounding("jpy", "0.01", "0.01");
      checkRounding("jpy", "0.0149", "0.01");
      checkRounding("jpy", "0.015", "0.02");
      checkRounding("jpy", "0.019", "0.02");
      checkRounding("jpy", "0.094", "0.09");
      checkRounding("jpy", "0.095", "0.1");
      checkRounding("jpy", "0.099", "0.1");
      checkRounding("jpy", "0.991", "0.99");
      checkRounding("jpy", "0.9949", "0.99");
      checkRounding("jpy", "0.995", "1");
      checkRounding("jpy", "0.999", "1");
      checkRounding("jpy", "9.9949", "9.99");
      checkRounding("jpy", "9.995", "10");
      checkRounding("jpy", "9.999", "10");


      checkRounding("Chf", "7,000000001", "7");
      checkRounding("Chf", "7,00000001", "7");
      checkRounding("Chf", "7,0000001", "7");
      checkRounding("Chf", "7,000001", "7");
      checkRounding("Chf", "7,00001", "7");
      checkRounding("Chf", "7,0001", "7");
      checkRounding("Chf", "7,001", "7");
      checkRounding("Chf", "7,004", "7");
      checkRounding("Chf", "7,0049", "7");
      checkRounding("Chf", "7,005", "7.01");
      checkRounding("Chf", "7,009", "7.01");
      checkRounding("Chf", "7,01", "7.01");
      checkRounding("Chf", "7,0149", "7.01");
      checkRounding("Chf", "7,015", "7.02");
      checkRounding("Chf", "7,019", "7.02");
      checkRounding("Chf", "7,094", "7.09");
      checkRounding("Chf", "7,095", "7.1");
      checkRounding("Chf", "7,099", "7.1");
      checkRounding("Chf", "7,991", "7.99");
      checkRounding("Chf", "7,9949", "7.99");
      checkRounding("Chf", "7,995", "8");
      checkRounding("Chf", "7,999", "8");
      checkRounding("Chf", "39,9949", "39.99");
      checkRounding("Chf", "39,995", "40");
      ...
      checkRounding("PHp", "78566666666666666666666690.00001", "78566666666666666666666690");
      checkRounding("PHp", "78566666666666666666666690.0001", "78566666666666666666666690");
      checkRounding("PHp", "78566666666666666666666690.001", "78566666666666666666666690");
      checkRounding("PHp", "78566666666666666666666690.004", "78566666666666666666666690");
      checkRounding("PHp", "78566666666666666666666690.0049", "78566666666666666666666690");
      checkRounding("PHp", "78566666666666666666666690.005", "78566666666666666666666690.01");
      checkRounding("PHp", "78566666666666666666666690.009", "78566666666666666666666690.01");
      checkRounding("PHp", "78566666666666666666666690.01", "78566666666666666666666690.01");
      checkRounding("PHp", "78566666666666666666666690.0149", "78566666666666666666666690.01");
      checkRounding("PHp", "78566666666666666666666690.015", "78566666666666666666666690.02");
      checkRounding("PHp", "78566666666666666666666690.019", "78566666666666666666666690.02");
      checkRounding("PHp", "78566666666666666666666690.094", "78566666666666666666666690.09");
      checkRounding("PHp", "78566666666666666666666690.095", "78566666666666666666666690.1");
      checkRounding("PHp", "78566666666666666666666690.099", "78566666666666666666666690.1");
      checkRounding("PHp", "78566666666666666666666690.991", "78566666666666666666666690.99");
      checkRounding("PHp", "78566666666666666666666690.9949", "78566666666666666666666690.99");
      checkRounding("PHp", "78566666666666666666666690.995", "78566666666666666666666691");
      checkRounding("PHp", "78566666666666666666666690.999", "78566666666666666666666691");
      ...
      checkRounding("BHD", "9999999999999999999999999,00001", "9999999999999999999999999");
      checkRounding("BHD", "9999999999999999999999999,0001", "9999999999999999999999999");
      checkRounding("BHD", "9999999999999999999999999,001", "9999999999999999999999999");
      checkRounding("BHD", "9999999999999999999999999,004", "9999999999999999999999999");
      checkRounding("BHD", "9999999999999999999999999,0049", "9999999999999999999999999");
      checkRounding("BHD", "9999999999999999999999999,005", "9999999999999999999999999.01");
      checkRounding("BHD", "9999999999999999999999999,009", "9999999999999999999999999.01");
      checkRounding("BHD", "9999999999999999999999999,01", "9999999999999999999999999.01");
      checkRounding("BHD", "9999999999999999999999999,0149", "9999999999999999999999999.01");
      checkRounding("BHD", "9999999999999999999999999,015", "9999999999999999999999999.02");
      checkRounding("BHD", "9999999999999999999999999,019", "9999999999999999999999999.02");
      checkRounding("BHD", "9999999999999999999999999,094", "9999999999999999999999999.09");
      checkRounding("BHD", "9999999999999999999999999,095", "9999999999999999999999999.1");
      checkRounding("BHD", "9999999999999999999999999,099", "9999999999999999999999999.1");
      checkRounding("BHD", "9999999999999999999999999,991", "9999999999999999999999999.99");
      checkRounding("BHD", "9999999999999999999999999,9949", "9999999999999999999999999.99");
      checkRounding("BHD", "9999999999999999999999999,995", "10000000000000000000000000");
      checkRounding("BHD", "9999999999999999999999999,999", "10000000000000000000000000");
      checkRounding("BHD", "7892767232313213989321748321974,9949", "7892767232313213989321748321974.99");
      checkRounding("BHD", "7892767232313213989321748321974,995", "7892767232313213989321748321975");
      checkRounding("BHD", "7892767232313213989321748321974,999", "7892767232313213989321748321975");
   }
   ...
   void commandAfterConversionTest() {
      ...
      withUnsupportedCurrency("PLN", "XXX", "0.1", true);
      assertCommand(START, START_MESSAGE);
